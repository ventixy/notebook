...
更多更详细的内容参照：[Java基本数据类型](/java/base/Java基础.md#基本数据类型)


1. Java 中包装类型和基本类型的区别是什么？
...
1. 什么是 Java 的 BigDecimal？  参照：[BigDecimal](/java/base/Java常用类库.md#_2-bigdecimal)
...
Java中处理字符串的主要类是String、StringBuilder和StringBuffer。 参考：[Java字符串](/java/base/数组和字符串.md#三-字符串-string)
...
更详细的内容参照：[Java参数传递](/java/base/Java基础.md#参数传递)
...
[Lambda表达式](/java/base/Lambda.html#lambda表达式) 和 [Stream API](/java/base/Stream.html#什么是stream)
